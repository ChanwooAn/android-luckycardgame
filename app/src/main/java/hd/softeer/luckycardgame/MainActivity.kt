...
class MainActivity : AppCompatActivity() {
    ...
    private fun initCardRecyclerView(){
        card_section_rv_list.forEach {
            it.layoutManager=LinearLayoutManager(this@MainActivity, RecyclerView.HORIZONTAL,false)
    ...
    private fun setCardRecyclerView(playerNum:Int){
        card_section_rv_list[playerNum].apply {
            val cardAdapter=CardSectionAdapter(viewModel.playersCardList.value!![playerNum].cardList,viewModel.cardWidth,viewModel.cardHeight,playerNum)
            adapter=cardAdapter
    ...
    private fun setSharedCardRecyclerView(playerNum: Int){
        ...
        binding.rvCardShared.apply {
            val cardAdapter=CardSectionAdapter(viewModel.sharedCardList.value!!,viewModel.cardWidth,viewModel.cardHeight,3)
            adapter=cardAdapter
